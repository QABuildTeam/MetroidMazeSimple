...
{
    public abstract class AnimatorHashedNameProperyDrawer : PropertyDrawer
    {
        protected abstract List<string> AnimatorNames(AnimatorController animatorController);
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            SerializedProperty animatorControllerProperty = property.FindPropertyRelative(nameof(AnimatorHashedName.animatorController));
            ...
            SerializedProperty nameProperty = property.FindPropertyRelative(nameof(AnimatorHashedName.name));
            ...
            StringPopup(new Rect(position.x + position.width / 3, position.y + verticalGap * 2, position.width * 2 / 3, height), nameProperty, AnimatorNames(animatorController));
